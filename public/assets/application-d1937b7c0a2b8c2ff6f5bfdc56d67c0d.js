...
(function() {
  ...
  jQuery(function() {
    if ($('#applyNow').length > 0) {
      $('#applyNowButton').bind('click', function() {
        return $('#applyNow').fadeOut('200', function() {
          $("#checkEmail").fadeIn('200');
          return $(".inputable").trigger('focus');
        });
      });
      return $('#SubmitEmail').bind('click', function() {
        return $('#HomePageForm').submit();
      });
    }
  });
...
(function() {
  ...
  jQuery(function() {
    ...
    return $('#new_r_app').submit(function() {
